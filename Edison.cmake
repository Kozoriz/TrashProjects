...
#Linux host
set(edison_sdk_root /opt/poky-edison/1.7.3)
if(${SDK_32bits})
  #32 bit SDK
...
#set(CMAKE_C_COMPILER /opt/poky-edison/1.7.3/sysroots/x86_64-pokysdk-linux/usr/bin/i586-poky-linux/i586-poky-linux-gcc)
#set(CMAKE_CXX_COMPILER /opt/poky-edison/1.7.3/sysroots/x86_64-pokysdk-linux/usr/bin/i586-poky-linux/i586-poky-linux-g++)
...
SET(CMAKE_CXX_FLAGS "-Os -g3 -Wall --sysroot=${CMAKE_SYSROOT} -m32 -march=i586 -ffunction-sections -fdata-sections -std=c++11 -lpthread"  CACHE STRING "" FORCE)
